...
<div class="d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="card mb-3 w-50">
        <div class="row g-0">
            <div class="col-md-4">
                <img style="max-width: 16rem" src={{ asset('storage/'.$publisher->image) }} class="img-fluid rounded-start">
            </div>
            <div class="col-md-8 p-5 mb-3">
                <div class="card-body">
                    <h5 class="card-title">{{$publisher->name}}</h5>
                    <p class="card-text text-muted"><b>Email : </b>{{$publisher->email}}</p>
    ...
    <div class="d-flex flex-row flex-wrap my-3 justify-content-center">
        @foreach ($books as $book)
            <div class="card justify-content-center mx-2 my-2 p-3" style="max-width: 15rem">
